...
class TopNav extends React.Component {
  tweet = 'GitHubStarNavigator – Most starred projects on Github by @aradhya https://github.com/aradhya/GitHubStarNavigator';
      ...
      <div className='top-nav'>
        <div className="container clearfix">
          ...
          <div className="float-right external-btns">
            <a href='http://github.com/aradhya/GitHubStarNavigator'
               target='_blank'
               rel="noopener noreferrer"
            ...
            {
              isRunningExtension && (
                <a href='https://twitter.com/aradhya'
                   target='_blank'
                   rel="noopener noreferrer"
                   className="btn btn-danger d-none d-sm-none d-md-inline-block d-xl-inline-block d-lg-inline-block">
